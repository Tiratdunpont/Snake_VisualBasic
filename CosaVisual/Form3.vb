Public Class Form3
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        If (directiona = 1 And dirpast <> 3) Then
            ...
            Else
                posx = 18
                If (img(posy, posx - 1).BackColor = Color.Green And final = False) Then
                    final = True
                    Timer1.Stop()
                    MessageBox.Show("Game Over")
                    Form1.Label2.Text = "Score: " & score
        ...
        ElseIf (directiona = 2 And dirpast <> 4) Then
            ...
            Else
                posy = -1
                If (img(posy + 1, posx).BackColor = Color.Green And final = False) Then
                    final = True
                    Timer1.Stop()
                    MessageBox.Show("Game Over")
                    Form1.Label2.Text = "Score: " & score
            ...
            End If
        ElseIf (directiona = 3 And Not dirpast = 1) Then
            If (posx < 17) Then
                If (img(posy, posx + 1).BackColor = Color.Black) Then
                    posx += 1
                    PosSnakey.Add(posy)
    ...
    Private Sub Form2_Closing(sender As Object, e As EventArgs) Handles MyBase.Closing
        If score > 999 Then
            If Form1.RadioButton1.Checked And Form1.easy2 = False Then
                Form1.easy2 = True
                Form1.ProgressBar1.PerformStep()
            ElseIf Form1.RadioButton2.Checked And Form1.medium2 = False Then
                Form1.medium2 = True
                Form1.ProgressBar1.PerformStep()
            ElseIf Form1.RadioButton3.Checked And Form1.hard2 = False Then
                Form1.hard2 = True
                Form1.ProgressBar1.PerformStep()
            End If
        End If
